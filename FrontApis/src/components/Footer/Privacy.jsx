    ...
    return (
        ...
        <div>
            <section>
                ...
                <br/>
                <p><strong>Fecha de última actualización:</strong> 18/10/2025</p>
                <p>En <strong>szafrankus</strong> (en adelante, “la Tienda”, “nosotros” o “nuestro”), nos
                    ...
                    proporcionás a través de nuestro sitio web.</p>
                <br/>
            </section>

            <section>
                <h2>1. Responsable del tratamiento de los datos</h2>
                <p><strong>szafrankus SA</strong><br/>
                    Domicilio: Lima 757<br/>
